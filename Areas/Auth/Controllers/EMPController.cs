...
namespace VEHICLEDETECTING.Areas.Auth.Controllers
{
    ...
    public class EMPController : myControllerAuth
    {
        ...
        public ActionResult Ajax_T_SYS_EMP_List(T_SYS_EMP Model, String KeyWord, Int32? PageIndex, Int32? PageSize, String SortCode, Boolean? IsAsc, DateTime? dt1, DateTime? dt2)
        {
        ...
        public ActionResult T_SYS_RMP_PRIVIEGE_TREE(Int32 ID = 0, String priviegeid = "")
        {
            ...
            LayData.zTreeData.TreeNodes = A.Exec(EF =>
            {
                ...
                var LPRIVIEGEs = Function.Emp_GetAllPrivieges_ByEmpID(ID);
